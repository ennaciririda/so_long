...
#    Updated: 2023/04/14 22:16:54 by rennacir         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
PARS = $(addprefix PARSING/, parsing.c parsing_1.c error.c valid_path.c return_dim.c count_coll.c)
LIBF = $(addprefix LIBF/, ft_strlen.c ft_strcmp.c)
GNL =  $(addprefix GNL/, get_next_line.c get_next_line_utils.c)
SRCS = main.c  $(PARS) $(LIBF) $(GNL) draw_map.c moves.c ft_putnbr.c
